...
目前的数据规模已经足够 99% 的日常场景所使用。该项目背后有一个持续运行的数据 pipeline，会抓取互联网上知名英文媒体的每日更新并加入数据集。你也可以随时给这个项目提 Issue 来协助补充缺失的单词。

## 与其它 AI 词典的区别

1. 持续更新 —— 该 AI 词典会持续更新，快速将新词纳入数据集
2. 更高质量的数据 —— 所有词条均使用最新 SOTA AI 模型生成（目前使用的是 gpt-5.2），而非各种量化模型
